...
/**
 * Script Name   : <b>TestHandicap5</b><br>
 * Generated     : <b>2018/11/18 7:34:38 PM</b><br>
 ...
 * @author Rodolfo
 */
public abstract class TestHandicap5Helper extends RationalTestScript
{
	/**
	...
	/**
	 * SpotNumberDisplay: with default state.
	 *		.captionText : 
	 * 		.class : client.maindisplay.SpotNumberDisplay
	 * 		accessibleContext.accessibleName : 
	 * 		.processName : javaw.exe
	 */
	protected TopLevelTestObject spotNumberDisplay() 
	{
		return new TopLevelTestObject(
                        getMappedTestObject("spotNumberDisplay"));
	}
	/**
	 * SpotNumberDisplay: with specific test context and state.
	 *		.captionText : 
	 * 		.class : client.maindisplay.SpotNumberDisplay
	 * 		accessibleContext.accessibleName : 
	 * 		.processName : javaw.exe
	 */
	protected TopLevelTestObject spotNumberDisplay(TestObject anchor, long flags) 
	{
		return new TopLevelTestObject(
                        getMappedTestObject("spotNumberDisplay"), anchor, flags);
	}
	...
	protected TestHandicap5Helper()
	{
		setScriptName("TestHandicap5");
	}
